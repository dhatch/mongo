...
class Empty {
public:
    void run() { ASSERT_EQUALS("{}", BSONObj().jsonString(Strict)); }
};
...
public:
    virtual ~Bad() {}
    void run() { ASSERT_THROWS(fromjson(json()), MsgAssertionException); }
...
class SingleString : public Base {
    ...
    virtual string json() const { return "{ \"a\" : \"b\" }"; }
};
...
class ReservedFieldName : public Bad {
    virtual string json() const { return "{ \"$oid\" : \"b\" }"; }
};

class ReservedFieldName1 : public Bad {
    virtual string json() const { return "{ \"$ref\" : \"b\" }"; }
};

class NumberFieldName : public Bad {
    virtual string json() const { return "{ 0 : \"b\" }"; }
};

class InvalidFieldName : public Bad {
    virtual string json() const { return "{ test.test : \"b\" }"; }
};

class QuotedNullName : public Bad {
    virtual string json() const { return "{ \"nc\0nc\" : \"b\" }"; }
};

class NoValue : public Bad {
    virtual string json() const { return "{ a : }"; }
};

class InvalidValue : public Bad {
    virtual string json() const { return "{ a : a }"; }
};
...
class OkDollarFieldName : public Base {
    ...
    virtual string json() const { return "{ \"$where\" : 1 }"; }
};
...
class SingleNumber : public Base {
    ...
    virtual string json() const { return "{ \"a\" : 1 }"; }
};
...
class RealNumber : public Base {
    ...
    virtual string json() const { return "{ \"a\" : 0.7 }"; }
};
...
class FancyNumber : public Base {
    ...
    virtual string json() const { return "{ \"a\" : -4.4433e-2 }"; }
};
...
class TwoElements : public Base {
    ...
    virtual string json() const { return "{ \"a\" : 1, \"b\" : \"foo\" }"; }
};
...
class Subobject : public Base {
    ...
    virtual string json() const { return "{ \"z\" : { \"a\" : 1 } }"; }
};
...
class DeeplyNestedObject : public Base {
    ...
    virtual BSONObj bson() const { return buildBson(35); }
    virtual string json() const { return buildJson(35); }
};
...
class TopLevelArrayEmpty : public Base {
    virtual BSONObj bson() const { return BSONArray(); }
    virtual string json() const { return "[]"; }
};
...
class TopLevelArray : public Base {
    ...
    virtual string json() const { return "[ 123, \"abc\" ]"; }
};
...
class Array : public Base {
    ...
    virtual string json() const { return "{ \"a\" : [ 1, 2, 3 ] }"; }
};
...
class True : public Base {
    ...
    virtual string json() const { return "{ \"a\" : true }"; }
};
...
class False : public Base {
    ...
    virtual string json() const { return "{ \"a\" : false }"; }
};
...
class Null : public Base {
    ...
    virtual string json() const { return "{ \"a\" : null }"; }
};
...
class Undefined : public Base {
    ...
    virtual string json() const { return "{ \"a\" : undefined }"; }
};
...
class UndefinedStrict : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$undefined\" : true } }"; }
};

class UndefinedStrictBad : public Bad {
    virtual string json() const { return "{ \"a\" : { \"$undefined\" : false } }"; }
};
...
class EscapedCharacters : public Base {
    ...
    virtual string json() const { return "{ \"a\" : \"\\\" \\\\ \\/ \\b \\f \\n \\r \\t \\v\" }"; }
};
...
class NonEscapedCharacters : public Base {
    ...
    virtual string json() const { return "{ \"a\" : \"\\% \\{ \\a \\z \\$ \\# \\' \\ \" }"; }
};
...
class AllowedControlCharacter : public Base {
    ...
    virtual string json() const { return "{ \"a\" : \"\x7f\" }"; }
};

class InvalidControlCharacter : public Bad {
    virtual string json() const { return "{ \"a\" : \"\x1f\" }"; }
};
...
class NumbersInFieldName : public Base {
    ...
    virtual string json() const { return "{ b1 : \"b\" }"; }
};
...
class EscapedUnicodeToUtf8 : public Base {
    ...
    virtual string json() const { return "{ \"a\" : \"\\ua000\\uA000\" }"; }
};
...
class Utf8Invalid : public Bad {
    virtual string json() const { return "{ \"a\" : \"\\u0ZZZ\" }"; }
};

class Utf8TooShort : public Bad {
    virtual string json() const { return "{ \"a\" : \"\\u000\" }"; }
};
...
class DBRefConstructorNumber : public Base {
    ...
    virtual string json() const { return "{ \"a\" : Dbref( \"ns\", 1 ) }"; }
};
...
class DBRefConstructorObject : public Base {
    ...
    virtual string json() const { return "{ \"a\" : Dbref( \"ns\", { \"b\" : true } ) }"; }
};
...
class DBRefNumberId : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$ref\" : \"ns\", \"$id\" : 1 } }"; }
};
...
class Oid2 : public Base {
    ...
    virtual string json() const { return "{ \"_id\" : ObjectId( \"0f0f0f0f0f0f0f0f0f0f0f0f\" ) }"; }
};
...
class Oid2TooShort : public Bad {
    virtual string json() const { return "{ \"_id\" : ObjectId( \"0f0f0f0f0f0f0f0f0f0f0f0\" ) }"; }
};
...
class Oid2InvalidChar : public Bad {
    virtual string json() const { return "{ \"_id\" : ObjectId( \"0f0f0f0f0f0fZf0f0f0f0f0f\" ) }"; }
};
...
class StringId : public Base {
    ...
    virtual string json() const { return "{ \"_id\" : \"000000000000000000000000\" }"; }
};
...
class BinDataNoType : public Bad {
    virtual string json() const { return "{ \"a\" : { \"$binary\" : \"AAAA\" } }"; }
};
...
class Date : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$date\" : 0 } }"; }
};
...
class DateNonzero : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$date\" : 1000000000 } }"; }
};
...
class DateStrictNegative : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$date\" : -1 } }"; }
};
...
class NumberLongTest : public Base {
    ...
    virtual string json() const { return "{ \"a\" : NumberLong( 20000 ) }"; }
};
...
class NumberIntTest : public Base {
    ...
    virtual string json() const { return "{ \"a\" : NumberInt( 20000 ) }"; }
};
...
class NumberLongBad : public Bad {
    virtual string json() const { return "{ \"a\" : NumberLong( 'sdf' ) }"; }
};

class NumberIntBad : public Bad {
    virtual string json() const { return "{ \"a\" : NumberInt( 'sdf' ) }"; }
};
...
class JSTimestamp : public Base {
    ...
    virtual string json() const { return "{ \"a\" : Timestamp( 20, 5 ) }"; }
};

class TimestampNoIncrement : public Bad {
    virtual string json() const { return "{ \"a\" : Timestamp( 20 ) }"; }
};
...
class TimestampZero : public Base {
    ...
    virtual string json() const { return "{ \"a\" : Timestamp( 0, 0 ) }"; }
};

class TimestampNoArgs : public Bad {
    virtual string json() const { return "{ \"a\" : Timestamp() }"; }
};

class TimestampFloatSeconds : public Bad {
    virtual string json() const { return "{ \"a\" : Timestamp( 20.0, 1 ) }"; }
};

class TimestampFloatIncrement : public Bad {
    virtual string json() const { return "{ \"a\" : Timestamp( 20, 1.0 ) }"; }
};
...
class TimestampInvalidSeconds : public Bad {
    virtual string json() const { return "{ \"a\" : Timestamp( q, 5 ) }"; }
};
...
class TimestampObjectNoIncrement : public Bad {
    virtual string json() const { return "{ \"a\" : { \"$timestamp\" : { \"t\" : 20 } } }"; }
};
...
class RegexNoOptionField : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$regex\" : \"b\" } }"; }
};
...
class RegexWithQuotes1 : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { $regex : \"\\\"\" }}"; }
};

class RegexInvalidField : public Bad {
    virtual string json() const { return "{ \"a\" : { \"$regex\" : \"b\", \"field\" : \"i\" } }"; }
};
...
class RegexInvalidOption2 : public Bad {
    virtual string json() const { return "{ \"a\" : /b/c }"; }
};

class RegexInvalidOption3 : public Bad {
    virtual string json() const { return "{ \"a\" : /b/ic }"; }
};
...
class RegexInvalidOption5 : public Bad {
    virtual string json() const { return "{ \"a\" : /b/a }"; }
};
...
class RegexEmpty : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$regex\" : \"\", \"$options\" : \"\"} }"; }
};
...
class Malformed4 : public Bad {
    string json() const { return "{ test : 1"; }
};
...
class Malformed6 : public Bad {
    string json() const { return "{ test : 1 , tst}"; }
};

class Malformed7 : public Bad {
    string json() const { return "{ a : []"; }
};

class Malformed8 : public Bad {
    string json() const { return "{ a : { test : 1 }"; }
};
...
class Malformed10 : public Bad {
    string json() const { return "{ a : [ { test : 1], b : 2}"; }
};

class Malformed11 : public Bad {
    string json() const { return "{ a : \"test\"string }"; }
};
...
class Malformed13 : public Bad {
    string json() const { return "{ a\"bad\" : \"teststring\" }"; }
};

class Malformed14 : public Bad {
    string json() const { return "{ \"a\"test : \"teststring\" }"; }
};

class Malformed15 : public Bad {
    string json() const { return "{ \"atest : \"teststring\" }"; }
};
...
class Malformed17 : public Bad {
    string json() const { return "{ atest\" : 1 }"; }
};
...
class UnquotedFieldName : public Base {
    ...
    virtual string json() const { return "{ a_b : 1 }"; }
};

class UnquotedFieldNameBad : public Bad {
    string json() const { return "{ 123 : 1 }"; }
};
...
class UnquotedFieldNameBad4 : public Bad {
    string json() const { return "{ -1.23 : 1 }"; }
};

class UnquotedFieldNameBad5 : public Bad {
    string json() const { return "{ 1e23 : 1 }"; }
};
...
class UnquotedFieldNameBad19 : public Bad {
    string json() const { return "{ bl\\u3333p: 1 }"; }
};

class UnquotedFieldNameBad20 : public Bad {
    string json() const { return "{ bl-33p: 1 }"; }
};
...
class SingleQuotes : public Base {
    ...
    virtual string json() const { return "{ 'ab\\'c\"' : 'bb\\b \\'\"' }"; }
};
...
class QuoteTest : public Base {
    ...
    virtual string json() const { return "{ '\"' : \"test\" }"; }
};
...
class ObjectId : public Base {
    ...
    virtual string json() const { return "{ \"_id\": ObjectId( \"deadbeeff00ddeadbeeff00d\" ) }"; }
};
...
class ObjectId2 : public Base {
    ...
    virtual string json() const { return "{ \"foo\": ObjectId( \"deadbeeff00ddeadbeeff00d\" ) }"; }
};
...
class NullString : public Base {
    ...
    virtual string json() const { return "{ \"x\" : \"a\\u0000b\" }"; }
};

class NullFieldUnquoted : public Bad {
    virtual string json() const { return "{ x\\u0000y : \"a\" }"; }
};

class MinKeyAlone : public Bad {
    virtual string json() const { return "{ \"$minKey\" : 1 }"; }
};

class MaxKeyAlone : public Bad {
    virtual string json() const { return "{ \"$maxKey\" : 1 }"; }
};
...
class MinKey : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$minKey\" : 1 } }"; }
};
...
class MaxKey : public Base {
    ...
    virtual string json() const { return "{ \"a\" : { \"$maxKey\" : 1 } }"; }
};
