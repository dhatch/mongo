...
Decimal128 Decimal128::add(const Decimal128& dec128, RoundingMode roundMode) const {
...
Decimal128 Decimal128::subtract(const Decimal128& rhs, RoundingMode roundMode) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::multiply(const Decimal128& rhs, RoundingMode roundMode) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::divide(const Decimal128& rhs, RoundingMode roundMode) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
...
bool Decimal128::isEqual(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
...
bool Decimal128::isNotEqual(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
    BID_UINT128 compare = Decimal128ToLibraryType(rhs.getValue());
    uint32_t idec_signaling_flags = 0;
...
bool Decimal128::isGreater(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
    BID_UINT128 compare = Decimal128ToLibraryType(rhs.getValue());
    uint32_t idec_signaling_flags = 0;
...
bool Decimal128::isGreaterEqual(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
    BID_UINT128 compare = Decimal128ToLibraryType(rhs.getValue());
    uint32_t idec_signaling_flags = 0;
...
bool Decimal128::isLess(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
    BID_UINT128 compare = Decimal128ToLibraryType(rhs.getValue());
    uint32_t idec_signaling_flags = 0;
...
bool Decimal128::isLessEqual(const Decimal128& rhs) const {
    BID_UINT128 current = Decimal128ToLibraryType(_value);
    BID_UINT128 compare = Decimal128ToLibraryType(rhs.getValue());
    uint32_t idec_signaling_flags = 0;
